...
// Эта функция используется для настройки выпадающих списков в ячейках или фильтрах jsGrid. Например:
// В режиме редактирования ячейки можно выбрать значение из выпадающего списка.
// В фильтре можно выбрать значение для фильтрации данных в таблице.
