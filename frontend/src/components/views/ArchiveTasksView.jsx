          ...
          <div className="touchpoint-list">
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <span className="task-date">Archived: 2 months ago</span>
                <div className="task_tracker_hashtags_container">
                  <span className="task_tracker_hashtag">Outdated</span>
                  <span className="task_tracker_hashtag">Removed</span>
                </div>
              </div>
            ...
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <span className="task-date">Archived: 1 week ago</span>
                <div className="task_tracker_hashtags_container">
