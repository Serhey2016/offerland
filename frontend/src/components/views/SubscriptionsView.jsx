          ...
          <div className="touchpoint-list">
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <div className="task_tracker_hashtags_container">
                  <span className="task_tracker_hashtag">$29.99/month</span>
                  <span className="task_tracker_hashtag">Active</span>
                </div>
              </div>
            ...
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <span className="task-date">Added: 3 days ago</span>
                <div className="task_tracker_hashtags_container">
                  <span className="task_tracker_hashtag">$9.99/month</span>
                  <span className="task_tracker_hashtag">Limited</span>
                </div>
              </div>
              <div className="task-actions">
                <button className="task_tracker_notes_btn">
