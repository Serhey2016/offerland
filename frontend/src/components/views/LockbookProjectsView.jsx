          ...
          <div className="touchpoint-list">
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <span className="task-date">Finished: Last week</span>
                <div className="task_tracker_hashtags_container">
                  <span className="task_tracker_hashtag">100% Complete</span>
                  <span className="task_tracker_hashtag">Delivered</span>
                </div>
              </div>
            ...
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <span className="task-date">Finished: 2 weeks ago</span>
                <div className="task_tracker_hashtags_container">
                  <span className="task_tracker_hashtag">100% Complete</span>
                  <span className="task_tracker_hashtag">Launched</span>
                </div>
              </div>
              <div className="task-actions">
                <button className="task_tracker_notes_btn">
