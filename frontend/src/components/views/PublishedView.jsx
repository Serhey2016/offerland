          ...
          <div className="touchpoint-list">
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <span className="task-date">Published: Today</span>
                <div className="task_tracker_hashtags_container">
                  <span className="task_tracker_hashtag">1.2k views</span>
                  <span className="task_tracker_hashtag">Tech</span>
                </div>
              </div>
            ...
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <h3>API Reference Update</h3>
                <span className="task-date">Published: Yesterday</span>
                <div className="task_tracker_hashtags_container">
                  <span className="task_tracker_hashtag">856 views</span>
                  <span className="task_tracker_hashtag">API</span>
                </div>
              </div>
              <div className="task-actions">
                <button className="task_tracker_notes_btn">
