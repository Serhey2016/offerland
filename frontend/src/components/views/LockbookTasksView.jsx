          ...
          <div className="touchpoint-list">
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <span className="task-date">Completed: Yesterday</span>
                <div className="task_tracker_hashtags_container">
                  <span className="task_tracker_hashtag">Approved</span>
                  <span className="task_tracker_hashtag">Security</span>
                </div>
              </div>
            ...
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <h3>Login Issue Resolved</h3>
                <span className="task-date">Completed: 3 days ago</span>
                <div className="task_tracker_hashtags_container">
                  <span className="task_tracker_hashtag">Fixed</span>
                  <span className="task_tracker_hashtag">Critical</span>
                </div>
              </div>
              <div className="task-actions">
                <button className="task_tracker_notes_btn">
...
export default LockbookTasksView
