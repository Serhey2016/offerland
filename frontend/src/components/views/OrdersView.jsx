          ...
          <div className="touchpoint-list">
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <div className="task_tracker_hashtags_container">
                  <span className="task_tracker_hashtag">$299.99</span>
                  <span className="task_tracker_hashtag">Pending</span>
                </div>
              </div>
            ...
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <div className="task_tracker_hashtags_container">
                  <span className="task_tracker_hashtag">$149.99</span>
                  <span className="task_tracker_hashtag">Processing</span>
                </div>
              </div>
              <div className="task-actions">
                <button className="task_tracker_notes_btn">
