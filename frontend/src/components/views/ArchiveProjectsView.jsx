          ...
          <div className="touchpoint-list">
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <h3>Deprecated Project</h3>
                <span className="task-date">Archived: 1 month ago</span>
                <div className="task_tracker_hashtags_container">
                  <span className="task_tracker_hashtag">Old Version</span>
                  <span className="task_tracker_hashtag">Replaced</span>
                </div>
              </div>
            ...
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <span className="task-date">Archived: 2 weeks ago</span>
                <div className="task_tracker_hashtags_container">
                  <span className="task_tracker_hashtag">Cancelled</span>
                  <span className="task_tracker_hashtag">Test</span>
                </div>
              </div>
              <div className="task-actions">
                <button className="task_tracker_notes_btn">
...
export default ArchiveProjectsView
