          ...
          <div className="touchpoint-list">
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <div className="task_tracker_hashtags_container">
                  <span className="task_tracker_hashtag">High Priority</span>
                  <span className="task_tracker_hashtag">Design</span>
                </div>
              </div>
            ...
            <div className="touchpoint-item">
              ...
              <div className="task-content">
                ...
                <span className="task-date">Added: 2 days ago</span>
                <div className="task_tracker_hashtags_container">
                  <span className="task_tracker_hashtag">Medium Priority</span>
                  <span className="task_tracker_hashtag">Documentation</span>
                </div>
              </div>
              <div className="task-actions">
                <button className="task_tracker_notes_btn">
