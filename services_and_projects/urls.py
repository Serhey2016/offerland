...
from .views import testpage, save_task_notes, save_job_search_notes, add_job_search_activity, change_advertising_status, start_task, get_edit_data, remove_advertising_photo, user_tasks, user_inbox_items, update_task_status, update_task_datetime, update_category, get_services_categories, get_services, get_task_subtasks
...
urlpatterns = [
    ...
    path('tasks/<int:task_id>/subtasks/', get_task_subtasks, name='get_task_subtasks'),
    path('elements/<slug:slug>/position/', update_category, name='update_category'),
    path('api/services-categories/', get_services_categories, name='get_services_categories'),
